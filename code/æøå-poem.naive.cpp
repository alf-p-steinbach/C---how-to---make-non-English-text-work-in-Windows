...
namespace app {
    ...
    //  in Windows, and this is so with MinGW g++ 11.2.
    ...
    void run()
    {
        ...
        //! Bug: per the standard the `fs::path` constructor assumes a `char`-based string is
        //  system Windows ANSI encoded in Windows, and this is so with MinGW g++ 11.2.
